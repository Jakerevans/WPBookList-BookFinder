...
function wpbooklist_bookfinder_search_action_javascript() { 
	...
	/*
				    	//console.log(results2.Items.Item);
				    	for (var i = 0; i < results2.Items.Item.length; i++) {
				    		...
				    		if(results2.Items.Item[i] != undefined){

				    			if(results2.Items.Item[i].SimilarProducts != undefined){
					    			if(results2.Items.Item[i].SimilarProducts.SimilarProduct != undefined){
					    				for (var r = 0; r < results2.Items.Item[i].SimilarProducts.SimilarProduct.length; r++) {
					    					similarproductsstring = similarproductsstring+';bsp;'+results2.Items.Item[i].SimilarProducts.SimilarProduct[r].ASIN+'---'+results2.Items.Item[i].SimilarProducts.SimilarProduct[r].Title;
					    				};
					    			}
				    			}
				    			...
				    			if(results2.Items.Item[i].ASIN != undefined){
				    				isbn = results2.Items.Item[i].ASIN;
				    			}

				    			if(results2.Items.Item[i].CustomerReviews != undefined){
				    				if(results2.Items.Item[i].CustomerReviews.IFrameURL != undefined){
				    					review = results2.Items.Item[i].CustomerReviews.IFrameURL;
				    				}
				    			}

				    			if(results2.Items.Item[i].DetailPageURL != undefined){
				    				details = results2.Items.Item[i].DetailPageURL;
				    			}

				    			if(results2.Items.Item[i].ItemAttributes != undefined){

					    			if(results2.Items.Item[i].ItemAttributes.Author != undefined){
					    				author = results2.Items.Item[i].ItemAttributes.Author;
					    			}

					    			if(results2.Items.Item[i].ItemAttributes.EAN != undefined){
					    				isbn = results2.Items.Item[i].ItemAttributes.EAN;
					    			}

					    			if(results2.Items.Item[i].ItemAttributes.NumberOfPages != undefined){
					    				pages = results2.Items.Item[i].ItemAttributes.NumberOfPages;
					    			}

					    			if(results2.Items.Item[i].ItemAttributes.Publisher != undefined){
					    				publisher = results2.Items.Item[i].ItemAttributes.Publisher;
					    			}

					    			if(results2.Items.Item[i].ItemAttributes.PublicationDate != undefined){
					    				pubdate = results2.Items.Item[i].ItemAttributes.PublicationDate;
					    			}

					    			if(results2.Items.Item[i].ItemAttributes.Title != undefined){
					    				title = results2.Items.Item[i].ItemAttributes.Title;
					    			}
				    			}

				    			if(results2.Items.Item[i].LargeImage != undefined && results2.Items.Item[i].LargeImage.URL != undefined){
				    				image = results2.Items.Item[i].LargeImage.URL;
				    			} else {
				    				image = '';
				    			}

				    			if(results2.Items.Item[i].EditorialReviews != undefined && results2.Items.Item[i].EditorialReviews.EditorialReview != undefined && results2.Items.Item[i].EditorialReviews.EditorialReview.Content){
				    				description = results2.Items.Item[i].EditorialReviews.EditorialReview.Content;
				    				description = description.replace(/"/g,'\'');
				    				description = description.replace(/“/g,'\'');
				    			}

				    			if(description == ''){
				    				if(results2.Items.Item[i].EditorialReviews != undefined && results2.Items.Item[i].EditorialReviews.EditorialReview[0] != undefined){
					    				description = results2.Items.Item[i].EditorialReviews.EditorialReview[0].Content;
					    				description = description.replace(/"/g,'\'');
					    				description = description.replace(/“/g,'\'');
				    				}
				    			}
				    	...
				    	for (var i = 0; i < results3.Items.Item.length; i++) {
				    		...
				    		if(results3.Items.Item[i] != undefined){

				    			if(results3.Items.Item[i].SimilarProducts != undefined){
					    			if(results3.Items.Item[i].SimilarProducts.SimilarProduct != undefined){
					    				for (var r = 0; r < results3.Items.Item[i].SimilarProducts.SimilarProduct.length; r++) {
					    					similarproductsstring = similarproductsstring+';bsp;'+results3.Items.Item[i].SimilarProducts.SimilarProduct[r].ASIN+'---'+results3.Items.Item[i].SimilarProducts.SimilarProduct[r].Title;
					    				};
					    			}
				    			}
				    			...
				    			if(results3.Items.Item[i].ASIN != undefined){
				    				isbn = results3.Items.Item[i].ASIN;
				    			}

				    			if(results3.Items.Item[i].CustomerReviews != undefined){
				    				if(results3.Items.Item[i].CustomerReviews.IFrameURL != undefined){
				    					review = results3.Items.Item[i].CustomerReviews.IFrameURL;
				    				}
				    			}

				    			if(results3.Items.Item[i].DetailPageURL != undefined){
				    				details = results3.Items.Item[i].DetailPageURL;
				    			}

				    			if(results3.Items.Item[i].ItemAttributes != undefined){

					    			if(results3.Items.Item[i].ItemAttributes.Author != undefined){
					    				author = results3.Items.Item[i].ItemAttributes.Author;
					    			}

					    			if(results3.Items.Item[i].ItemAttributes.EAN != undefined){
					    				isbn = results3.Items.Item[i].ItemAttributes.EAN;
					    			}

					    			if(results3.Items.Item[i].ItemAttributes.NumberOfPages != undefined){
					    				pages = results3.Items.Item[i].ItemAttributes.NumberOfPages;
					    			}

					    			if(results3.Items.Item[i].ItemAttributes.Publisher != undefined){
					    				publisher = results3.Items.Item[i].ItemAttributes.Publisher;
					    			}

					    			if(results3.Items.Item[i].ItemAttributes.PublicationDate != undefined){
					    				pubdate = results3.Items.Item[i].ItemAttributes.PublicationDate;
					    			}

					    			if(results3.Items.Item[i].ItemAttributes.Title != undefined){
					    				title = results3.Items.Item[i].ItemAttributes.Title;
					    			}
				    			}

				    			if(results3.Items.Item[i].LargeImage != undefined && results3.Items.Item[i].LargeImage.URL != undefined){
				    				image = results3.Items.Item[i].LargeImage.URL;
				    			} else {
				    				image = '';
				    			}

				    			if(results3.Items.Item[i].EditorialReviews != undefined && results3.Items.Item[i].EditorialReviews.EditorialReview != undefined && results3.Items.Item[i].EditorialReviews.EditorialReview.Content){
				    				description = results3.Items.Item[i].EditorialReviews.EditorialReview.Content;
				    				description = description.replace(/"/g,'\'');
				    				description = description.replace(/“/g,'\'');
				    			}

				    			if(description == ''){
				    				if(results3.Items.Item[i].EditorialReviews != undefined && results3.Items.Item[i].EditorialReviews.EditorialReview[0] != undefined){
					    				description = results3.Items.Item[i].EditorialReviews.EditorialReview[0].Content;
					    				description = description.replace(/"/g,'\'');
					    				description = description.replace(/“/g,'\'');
				    				}
				    			}
...
/*
function wpbooklist_bookfinder_action_javascript() { 
	?>
  	<script type="text/javascript" >
  	"use strict";
  	jQuery(document).ready(function($) {
	  	$("#wpbooklist-bookfinder-button").click(function(event){
			...
			sleep.prevent();
	  		...
	  		var library = $('#wpbooklist-bookfinder-select-library').val();
	  		var createPost = $( "input[name='bookfinder-create-post']" ).prop('checked');
	  		var createPage = $( "input[name='bookfinder-create-post']" ).prop('checked');
	  		var woocommerce = $( "input[name='bookfinder-create-woo']" ).prop('checked');
	  		var isbnString = $('#wpbooklist-bookfinder-textarea').val();
	  		var statusDiv = $('#wpbooklist-bookfinder-status-div');
	  		var spinner = $('#wpbooklist-spinner-bookfinder');
	  		var titleResponseDiv = $('#wpbooklist-bookfinder-title-response');
	  		var addButton = $('#wpbooklist-bookfinder-button');
	  		var smileIcon = $('#wpbooklist-smile-icon-1');
	  		var titleResponse = '';
	  		var totalAdded = 0;
	  		var scrollTop = 0;
		    ...
		    if(errorFlag === false){
		    	addButton.prop('disabled', true);
		  		...
		  		(function wpbooklist_bookfinder_add_book_worker() {
		  			...
		  			var data = {
						'action': 'wpbooklist_bookfinder_action',
						'security': '<?php echo wp_create_nonce( "wpbooklist_bookfinder_action_callback" ); ?>',
...
// Callback function for creating backups
function wpbooklist_bookfinder_action_callback(){
	global $wpdb;
	check_ajax_referer( 'wpbooklist_bookfinder_action_callback', 'security' );
